...
{
    [Preserve]
    public class VehicleNavigationUseCase: IDisposable, IAsyncStartable
    {
        private readonly IHangarGateway _hangarGateway;
        private readonly UseCaseMediator _useCaseMediator;
        private readonly IVehicleNavigationFactory _vehicleFactory;
        ...
        internal VehicleNavigationUseCase(IHangarGateway hangarGateway, UseCaseMediator useCaseMediator, IVehicleNavigationFactory vehicleFactory)
        {
        ...
        public async UniTask StartAsync(CancellationToken cancellation = new CancellationToken())
        {
            ...
            await SetCurrentVehicle(cancellation);
        }
        ...
        private async UniTask SetCurrentVehicle(CancellationToken cancellationToken)
        {
            await SetNearVehicle(0, cancellationToken);
        }
